...
from fuseline.core.network import WorkflowNotFoundException
from fuseline.core.parser import fuselineConfig, get_fuseline_config
...
def run(ctx, workflow_name: str):
    ...
    fuseline_config: fuselineConfig = get_fuseline_config()
    try:
        workflow = fuseline_config[workflow_name]
